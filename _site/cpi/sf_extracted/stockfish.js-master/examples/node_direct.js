...
if (process.argv[2] === "--help" || process.argv[2] === "-h") {
	...
	console.log(
		'   node simple_node.js "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2"',
	);
...
try {
	var fs = require("fs");
	var p = require("path");
	var pathToEngine = p.join(
		__dirname,
		"..",
		"src",
		fs.readlinkSync(p.join(__dirname, "../src/stockfish.js")),
	);
